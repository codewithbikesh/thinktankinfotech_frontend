    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        ...
        <span className="text-green-600">Why Choose Us for</span>{" "}
          <span className="text-orange-600">System/Software Development?</span> 
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Feature 1 */}
          <div className="bg-white rounded-lg shadow-md p-6 group">
            <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-orange-600">Tailored Solutions</h3>
          ...
          {/* Feature 2 */}
          <div className="bg-white rounded-lg shadow-md p-6 group">
            <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-orange-600">Scalability & Performance</h3>
            <p className="text-gray-600">
          ...
          {/* Feature 3 */}
          <div className="bg-white rounded-lg shadow-md p-6 group">
            <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-orange-600">Seamless Integration</h3>
            <p className="text-gray-600">
          ...
          {/* Feature 4 */}
          <div className="bg-white rounded-lg shadow-md p-6 group">
            <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-orange-600">Agile Development Process</h3>
            <p className="text-gray-600">
          ...
          {/* Feature 5 */}
          <div className="bg-white rounded-lg shadow-md p-6 group">
            <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-orange-600">Secure & Reliable</h3>
            <p className="text-gray-600">
          ...
          {/* Feature 6 */}
          <div className="bg-white rounded-lg shadow-md p-6 group">
            <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-orange-600">End-to-End Support</h3>
            <p className="text-gray-600">
