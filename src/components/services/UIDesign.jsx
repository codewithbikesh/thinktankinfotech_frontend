    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        ...
        <span className="text-green-600">Why Choose Us for Your</span>{" "}
          <span className="text-orange-600">UI/UX Design Needs?</span> 
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Feature 1 */}
          <div className="bg-white rounded-lg shadow-md p-6 group">
            <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-orange-600">User-Centered Design</h3>
          ...
          {/* Feature 2 */}
          <div className="bg-white rounded-lg shadow-md p-6 group">
            <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-orange-600">Intuitive Interfaces</h3>
            <p className="text-gray-600">
          ...
          {/* Feature 4 */}
          <div className="bg-white rounded-lg shadow-md p-6 group">
            <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-orange-600">Prototyping & Testing</h3>
            <p className="text-gray-600">
          ...
          {/* Feature 6 */}
          <div className="bg-white rounded-lg shadow-md p-6 group">
            <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-orange-600">Ongoing Collaboration</h3>
            <p className="text-gray-600">
